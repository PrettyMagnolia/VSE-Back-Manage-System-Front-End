  ...
  <el-dialog v-model="dialogTableVisible" title="新增课程">
    <el-form :model="addCourseForm" :rules="courseRules" ref="ruleFormRef" label-width="120px">
      ...
      <el-form-item label="授课教师工号" prop="teacherId">
        <el-input v-model="addCourseForm.teacherId" placeholder="2001001" />
      </el-form-item>
    ...
    <div>
      ...
      <el-pagination
        v-model:current-page="studentPageParams.currentPage" v-model:page-size="studentPageParams.pageSize"
